...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11031 - KANTAYAPALAM SHRAVYA $^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
$https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/shravya.wav
\end{lstlisting}
...
\item
The output of the python script in Problem \ref{prob:output} is the audio file shravya-filtered.wav. Play the file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?
\\
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code1.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code1.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code3.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code6.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code7.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code8.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code9.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{-3.6580603}y(n - 1) + \brak{5.03143353}y(n - 2) \nonumber \\
	&- \brak{-3.0832283 }y(n - 3) + \brak{0.7101039}y(n - 4) \nonumber \\
	&= \brak{1.55517218\times 10^{-5}}x(n) + \brak{6.22068871\times 10^{-5}}x(n - 1) \nonumber \\
	&+ \brak{9.33103307\times 10^{-4}}x(n - 2) + \brak{6.22068871\times 10^{-5}}x(n - 3) \nonumber \\
	&+ \brak{1.55517218 \times 10^{-5}}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code10.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/shravya-kantayapalam/Audio-Filter/blob/main/codes/code11.py
\end{lstlisting}
\begin{figure}[H]
\centering
